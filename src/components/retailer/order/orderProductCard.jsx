        ...
        <div className="order-product-card">
            ...
            <div className="order-product-card-detail">
                ...
                <div className={`order-product-card-detail-3-state`}>
                    ...
                    {order?.state === 'pending' && (
                        <>
                            <div className={`order-product-card-detail-3-state-confirmed`}>CONFIRM</div>
                            <div className={`order-product-card-detail-3-state-cancel`}>CANCEL</div>
                        </>
                    )}
                    {order?.state === 'confirmed' && (
                        <>
                            <div className={`order-product-card-detail-3-state-dispatch`}>DISPATCH</div>
                            <div className={`order-product-card-detail-3-state-cancel`}>CANCEL</div>
                        </>
                    )}
                </div>
